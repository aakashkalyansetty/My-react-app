...
export default function CustomizedTables(props) {
  ...
  return (
    <div>
      <Header/>
        <h2 className="users">Validations for Forte</h2>
    ...
    <TablePagination
      ...
      />
    <button className="btn btn-primary add-user" onClick={event => window.location.href='/ForteForm'}>Add Validation</button>
    </div>
    </div>
  );
}