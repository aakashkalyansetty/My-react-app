...
import './DuplicateCheckIndex.css';
...
export default function CustomizedTables(props) {
  ...
  return (
    <div>
      <Header/>
        <h2 className="users">Validations for Duplicate Check</h2>
    ...
    <TablePagination
      ...
      />
    <button className="btn btn-primary add-user" onClick={event => window.location.href='/DuplicateCheckForm'}>Add Validation</button>
    </div>
    </div>
  );
}